...
/opt/android-sdk/emulator/emulator -ports $PORT1,$PORT2 -avd EmulatorInDocker -skip-adb-auth -no-window -gpu swiftshader_indirect -no-snapshot -noaudio -no-boot-anim &
